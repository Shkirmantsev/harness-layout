...
Client requirements for progress updates, safety warnings, permission requests, and self-contained final answers override the no-narration compression rules below. Compress content without hiding state, evidence, risk, or required user choices.
