...
- Project access remains the responsibility of the native `hermes-tailscale-worker` SSH backend and the dedicated ACL-limited `hermes-worker` account on the main machine.
