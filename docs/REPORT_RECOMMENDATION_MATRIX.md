...
| Skill discovery | Keep a small P0 set discoverable and load 3–7 task skills progressively. Never load full skill bodies to decide which skill to load. | Adopted. Four core skills remain directly discoverable; optional skills live in `.agents/skills/catalog/`. | `scripts/skill_router.py`, `.agents/skills/skill-router/`, `scripts/sync_skills.py`. |
